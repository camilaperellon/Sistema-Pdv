...
class Cliente extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'tblVendas' => array(self::HAS_MANY, 'TblVenda', 'cliente_id'),
		);
	}
